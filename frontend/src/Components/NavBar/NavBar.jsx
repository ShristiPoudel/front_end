    ...
    <div className="navbar">
      ...
      <ul className="nav-menu">
        ...
        {isLoggedIn && userRole === "attendee" && (
          <>
            <li>
              <Link to="/attendee-dashboard/book-event">My Ticket</Link>
            </li>
          </>
        )}
        ...
        <div className="hamburger-menu" onClick={toggleMenu}>
          ...
          <ul className={`nav-menu ${menuOpen ? "active" : ""}`}>
              ...
              {!isLoggedIn ? (
                ...
                <>
                  <Link to="/profile">
                    {use?.image ? (
                      <img
                        src={use.image}
                        alt="Profile"
                        className="profile-avatar-iconham"
                      />
                    ) : (
                  ...
                  <Link to="/notifications" className="notification-wrapper">
                    ...
                    {unreadCount > 0 && (
                      <span className="notification-badge-ham">
                        {unreadCount}
                      </span>
                    )}
                  </Link>
            ...
            {isLoggedIn && userRole === "organizer" && (
              <li>
                <Link
                  to="/organizer-dashboard/create-events"
            ...
            {isLoggedIn && userRole === "attendee" && (
              <li>
                <Link
                  to="/attendee-dashboard/book-event"
                  onClick={() => setMenuOpen(false)}
                >
                  My Ticket
                </Link>
